...
object Training {
    ...
    fun main(args: Array<String>) {
        ...
        // An empty scan means the package prefix stopped matching — a cache with
        // none of the app's classes in it is worse than useless, because it still
        // loads and still looks like it worked.
